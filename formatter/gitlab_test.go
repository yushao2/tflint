...
func Test_jsonPrint(t *testing.T) {
	cases := []struct {
		...
		},
		{
			...
			Stdout: `[{"description":"Failed to work; I don't feel like working","severity":"major"}]`,
		},
		{
			Name: "error",
			Error: fmt.Errorf(
			...
			Stdout: `[{"description":"detail","fingerprint":"20596331cc348dc6bfae9181bfdb966f","severity":"minor","location":{"path":"filename","lines":{"begin":1}}}]`,
		},
	}
	...
	for _, tc := range cases {
		stdout := &bytes.Buffer{}
		stderr := &bytes.Buffer{}
		formatter := &Formatter{Stdout: stdout, Stderr: stderr, Format: "gitlab"}
